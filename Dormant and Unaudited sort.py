...
# Paths
input_excel = '/Volumes/SamsungSSD/24 YTD refiner.xlsx'  # Path to your input XLSX file
backup_excel = '/Volumes/SamsungSSD/24_YTD_refiner_backup.xlsx'  # Backup XLSX file
output_csv = '/Volumes/SamsungSSD/24_YTD_refiner_results.csv'  # Output CSV file
...
registration_number_patterns = [r'registration number', r'company number', r'number:\s?\d{5,}']
...
# Function to extract the value near a keyword
def extract_value_near_keyword(content, keyword):
    ...
    if keyword_index != -1:
        ...
        if len(surrounding_text) > 1:
            # Assuming the value is the word after the keyword
            return surrounding_text[1]
    return None
    ...
    if os.path.exists(file_path):  # Check if file exists
        try:
            ...
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                # Search for turnover (look for the value near the keyword)
                turnover = None
